...
public class Level_21_Manager_data_part_III extends BaseTest {
	private WebDriver driver;
	  ...
	  public void beforeClass(String browserName) {
	    ...
	    correctPassword = UserData.register.PASSWORD;
	    invalidEmail = "afc";
	    emailAddress = UserData.register.EMAIL_ADDRESS + genarateFakeNumber() + "@mail.vn";
	    gender ="Female";
