...
public class AdminPostAddNewPageUI {
	 ...
	 public static final String PUBLISH_OR_EDIT_BUTTON ="css=div[aria-label='Editor top bar'] button[class*='editor-post-publish-button']";
	 public static final String PRE_PUBLISH_BUTTON ="css=div[aria-label='Editor publish'] button[class*='editor-post-publish-button']";
	 public static final String PUBLISH_OR_EDIT_MESSAGE ="xpath=//div[@class='components-snackbar__content' and text()='%s']";
}
