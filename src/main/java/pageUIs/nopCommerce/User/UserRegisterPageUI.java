...
public class UserRegisterPageUI {
	...
	public static final String CONFFIRM_PASSWORD_TEXTBOX = "xpath=//input[@id='ConfirmPassword']";
	...
	public static final String CONFFIRM_PASSWORD_ERROR_MESSAGE = "xpath=//span[@id='ConfirmPassword-error']";
	public static final String REGISTER_SUCCESS_MESSAGE = "xpath=//div[@class='result']";
	public static final String EXISTING_ERROR_MESSAGE = "xpath=//div[contains(@class,'message-error')]//li";
}
